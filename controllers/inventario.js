 ...
 */
 const getInventarioByID = async (req = request, res = response) => {
    try{
        ...
        // TODO: Lo sentimos, no se encuntra
 ...
 */
 const createInventario = async (req = request, res = response) => {
    try{
        ...
        // TAREA: Validar que la marca, el estado y el tipo de equipo existan, además de si estan activos = (1)
...
/**
 * Importa una foto del equipo al inventario
 */
